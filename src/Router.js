...
const Editprofile=lazy(()=>import('./views/apps/user/Editprofile.js'))
// Report //
...
const PTappointlist=lazy(()=>import('./views/apps/user/Patientdashboard/PTappointment'))

const PTcallhistorylist=lazy(()=>import('./views/apps/user/Patientdashboard/PTcallhistory'))

const PTchathistorylist=lazy(()=>import('./views/apps/user/Patientdashboard/PTchathistory'))


const PTvideohistorylist=lazy(()=>import('./views/apps/user/Patientdashboard/PTvideocallhistory'))

const PTphysicalvhistorylist=lazy(()=>import('./views/apps/user/Patientdashboard/PTphysicalvisithistory'))
const Prescribtion = lazy(() =>
  import("./views/pages/Prescribtion/Prescribtion.js")
);

const PTprescriptionhistorylist=lazy(()=>import('./views/apps/user/Patientdashboard/PTprescriptionhistory'))

const PTpendingorderlist=lazy(()=>import('./views/apps/user/PatientOrderManagement/PTpendinglist'))

const PTcompleteorderlist=lazy(()=>import('./views/apps/user/PatientOrderManagement/PTcompletelist'))

const PTcancelorderlist=lazy(()=>import('./views/apps/user/PatientOrderManagement/PTcancelledlist'))

const PTtestpendinglist=lazy(()=>import('./views/apps/user/PatientDiagmangement/PTpendingtestreport'))

const PTtestdeliveredlist=lazy(()=>import('./views/apps/user/PatientDiagmangement/PTdeliveredreport'))

const PTwallethistory=lazy(()=>import("./views/apps/user/Patientfinancemanagement/PTwallethistory"))

const PTtranscationhistory=lazy(()=>import("./views/apps/user/Patientfinancemanagement/PTtranscationhistory"))


const PTwithdrawrequest=lazy(()=>import("./views/apps/user/Patientfinancemanagement/PTwithdrawrequest"))
...
const ChatInTakeListform = lazy(() =>
  import("./views/apps/chatintakeform/formchat")
);
...
const Activity=  lazy(() => import("./views/dashboard/analytics/ActivityTimeline"));
const DispatchedOrders=  lazy(() => import("./views/dashboard/analytics/DispatchedOrders"));
      ...
      <Router history={history}>
        <HashRouter>
          <Switch>
            ...
            <AppRoute path='/app/user/Edit-profile' component={Editprofile}/>
...
{/* ///////////////////////////////////////////////////////////////////////////PATIENT DAshboard */}
<AppRoute
              path="/app/user/Patientdashboard/PTappointment"
              component={PTappointlist}
            />
<AppRoute
              path="/app/user/Patientdashboard/PTcallhistory"
              component={PTcallhistorylist}
            />
<AppRoute
              path="/app/user/Patientdashboard/PTchathistory"
              component={PTchathistorylist}
            />

<AppRoute
              path="/app/user/Patientdashboard/PTvideocallhistory"
              component={PTvideohistorylist}
            />

<AppRoute
              path="/app/user/Patientdashboard/PTphysicalvisithistory"
              component={PTphysicalvhistorylist}
            />
       <AppRoute path="/page/Prescribtion" component={Prescribtion} />

<AppRoute
              path="/app/user/Patientdashboard/PTprescriptionhistory"
              component={PTprescriptionhistorylist}
            />

<AppRoute
              path="/app/user/PatientOrderManagement/PTpendinglist"
              component={PTpendingorderlist}
            />

<AppRoute
              path="/app/user/PatientOrderManagement/PTcompletelist"
              component={PTcompleteorderlist}
            />


<AppRoute
              path="/app/user/PatientOrderManagement/PTcancelledlist"
              component={PTcancelorderlist}
            />

<AppRoute
              path="/app/user/PatientDiagmangement/PTpendingtestreport"
              component={PTtestpendinglist}
            />

<AppRoute
              path="/app/user/PatientDiagmangement/PTdeliveredreport"
              component={PTtestdeliveredlist}
            />

<AppRoute
              path="/app/user/Patientfinancemanagement/PTwallethistory"
              component={PTwallethistory}
            />
<AppRoute
              path="/app/user/Patientfinancemanagement/PTtranscationhistory"
              component={PTtranscationhistory}
            />
<AppRoute
              path="/app/user/Patientfinancemanagement/PTwithdrawrequest"
              component={PTwithdrawrequest}
            />
...
{/* ///////////////////////////////////////////////////////////////////////////PATIENT DAshboard */}
          ...
          />
            ...
            />
            <AppRoute
              path="/apps/chatintakeform/formchat"
              component={ChatInTakeListform}
            />
...
<AppRoute path="/dashboard/analytics/ActivityTimeline" component={Activity} />


<AppRoute path="/dashboard/analytics/DispatchedOrders" component={DispatchedOrders} />
