...
class PTphysicalvisithistory extends React.Component {
  state = {
    rowData: [],
  ...
  render() {
    ...
    return (
      ...
      (
        <div>
          <Breadcrumbs
            breadCrumbTitle="Physical Visit History"
            breadCrumbParent="Physical Visit List"
...
export default PTphysicalvisithistory;
