...
class PTprescriptionhistory extends React.Component {
  state = {
    rowData: [],
                      ...
                      <Route
                          render={({ history }) => (
                              <Eye
                                  ...
                                  onClick={() =>
                                      history.push(
                                          `/page/Prescribtion/${params.data._id}`
                                      )
                                  }
                              />
                          )}
  ...
  render() {
    ...
    return (
      ...
      (
        <div>
          <Breadcrumbs
            breadCrumbTitle="Prescription History"
...
export default PTprescriptionhistory;
