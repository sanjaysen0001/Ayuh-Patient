...
class PTChatReport extends React.Component {
  state = {
    rowData: [],
  ...
  render() {
    ...
    return (
      ...
      (
        <div>
          <Breadcrumbs
            breadCrumbTitle="Chat History"
            breadCrumbParent="Chat History List"
            // breadCrumbActive=" Chat History"
          />
